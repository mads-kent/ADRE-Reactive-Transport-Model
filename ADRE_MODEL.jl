...
#NOTE!!! This function defines τ as negative. This is important to note with the signs of α and β which are negative and positive respectively. The sign assignment is opposite to that of the sim.function() code due to the definition of the exponential function.
...
function sim_function(α, β, K_optim, T_0, T_f)
	...
	#NOTE!!! α and β are opposite from the manuscript in signs in teh following lines of code. This is due to the definition of the exponential function created for the code. 
